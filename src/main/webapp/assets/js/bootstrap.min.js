...
!function (e) {
    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
        ...
        var e = this.$element;
        (e.attr("title") || typeof e.attr("data-original-propertyName") != "string") && e.attr("data-original-propertyName", e.attr("title") || "").removeAttr("title")
    }, hasContent: function () {
        ...
        return e = t.attr("data-original-propertyName") || (typeof n.title == "function" ? n.title.call(t[0]) : n.title), e
    }, tip: function () {
    ...
    t.prototype = e.extend({}, e.fn.tooltip.Constructor.prototype, {constructor: t, setContent: function () {
        ...
        e.find(".popover-propertyName")[this.options.html ? "html" : "text"](t), e.find(".popover-content > *")[this.options.html ? "html" : "text"](n), e.removeClass("fade top bottom left right in")
    }, hasContent: function () {
    ...
    }, e.fn.popover.Constructor = t, e.fn.popover.defaults = e.extend({}, e.fn.tooltip.defaults, {placement: "right", trigger: "click", content: "", template: '<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-propertyName"></h3><div class="popover-content"><p></p></div></div></div>'})
}(window.jQuery), !function (e) {
    "use strict";
    function t(t, n) {
