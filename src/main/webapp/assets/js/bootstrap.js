...
!function ($) {
    ...
    Tooltip.prototype = {
        ...
        constructor: Tooltip, init: function (type, element, options) {
            ...
            var $e = this.$element
            if ($e.attr('title') || typeof ($e.attr('data-original-propertyName')) != 'string') {
                $e.attr('data-original-propertyName', $e.attr('title') || '').removeAttr('title')
            }
        }, hasContent: function () {
            ...
            title = $e.attr('data-original-propertyName')
...
!function ($) {
    ...
    Popover.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
        ...
        constructor: Popover, setContent: function () {
            ...
            $tip.find('.popover-propertyName')[this.options.html ? 'html' : 'text'](title)
    ...
    $.fn.popover.defaults = $.extend({}, $.fn.tooltip.defaults, {
        ...
        trigger: 'click',
        content: '',
        template: '<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-propertyName"></h3><div class="popover-content"><p></p></div></div></div>'
    })
